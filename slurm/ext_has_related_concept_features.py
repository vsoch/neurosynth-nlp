...
for row in sys.stdin:
    ...
    relation_id = parts[1]
    c1_start, c1_length, c2_start, c2_length = [int(x) for x in parts[2:]]

    # Unpack input into tuples.
    span1 = ddlib.Span(begin_word_id=c1_start, length=c1_length)
    span2 = ddlib.Span(begin_word_id=c2_start, length=c2_length)
